...
engine = sqlalchemy.create_engine('mysql+pymysql://root:192824@localhost:3306/medical_sample_data')
data = pd.read_sql_table("sampla_data_08_05_2022(final)", engine)

data.columns

data1= data.drop(["ï»¿Patient_ID"], axis=1)
